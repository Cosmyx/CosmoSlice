...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed), std::pair<wxColour, int>(wxColour(171, 71, 188), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Normal));
    m_button_cali->SetBackgroundColor(m_btn_bg_green);
    m_button_cali->SetFont(Label::Body_13);
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Enabled) });
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed), std::pair<wxColour, int>(wxColour(171, 71, 188), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Normal));
    m_cali_cancel->SetBackgroundColor(m_btn_bg_green);
    m_cali_cancel->SetBorderColor(wxColour(156, 39, 176));
    ...
    m_button_save_result->SetBorderColor(wxColour(156, 39, 176));
