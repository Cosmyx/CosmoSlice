...
void AMSMaterialsSetting::create()
{
    ...
    m_button_confirm->SetBorderColor(wxColour(156, 39, 176));
...
void AMSMaterialsSetting::create_panel_normal(wxWindow* parent)
{
    ...
    m_readonly_filament->SetBorderColor(StateColor(std::make_pair(0xDBDBDB, (int)StateColor::Focused), std::make_pair(0x9C27B0, (int)StateColor::Hovered),
