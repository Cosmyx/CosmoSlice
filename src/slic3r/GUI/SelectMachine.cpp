    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_btn_bg_enable = StateColor(std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed), std::pair<wxColour, int>(wxColour(171, 71, 188), StateColor::Hovered),
    ...
    m_statictext_finish->SetForegroundColour(wxColour(156, 39, 176));
