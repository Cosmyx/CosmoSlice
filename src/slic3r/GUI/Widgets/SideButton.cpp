    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(171, 71, 188), StateColor::Hovered);
    border_color.append(0x9C27B0, StateColor::Normal);
    ...
    background_color.append(wxColour(171, 71, 188), StateColor::Hovered);
    background_color.append(0x9C27B0, StateColor::Normal);
