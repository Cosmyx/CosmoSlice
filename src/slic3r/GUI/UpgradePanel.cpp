...
static const wxColour TEXT_NORMAL_CLR = wxColour(156, 39, 176);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(171, 71, 188), StateColor::Hovered), std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(156, 39, 176), StateColor::Enabled));
